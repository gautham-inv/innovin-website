...
export default function Footer() {
  ...
  return (
    <footer className="bg-white min-h-[600px] sm:min-h-[700px] lg:h-[962px] overflow-hidden relative pt-8 sm:pt-12 lg:pt-0 px-4 sm:px-6 lg:px-[70px] pb-4 sm:pb-6 lg:pb-[70px] lg:flex lg:items-center">
      <div className="relative bg-black min-h-[550px] sm:min-h-[650px] lg:h-[850.707px] w-full max-w-[1593px] mx-auto rounded-[20px] sm:rounded-[24px] lg:rounded-[29.301px] overflow-hidden p-6 sm:p-10 lg:p-0">
        {/* Main Tagline */}
        ...
        {/* Divider */}
        <div className="lg:absolute lg:left-[79.11px] lg:right-[79.11px] lg:top-[757.92px] bg-[#393f45] h-[1px] lg:h-[0.977px] w-full lg:w-auto mb-6 sm:mb-8 lg:mb-0"></div>

        {/* Footer Bottom */}
        <div className="lg:absolute lg:left-[79.11px] lg:right-[79.11px] lg:bottom-[55px] lg:top-auto lg:w-auto flex flex-col sm:flex-row flex-wrap gap-4 items-start sm:items-center justify-between text-white text-[13px] sm:text-[14px] lg:text-[15.627px] leading-[1.5] sm:leading-[27.884px]">
